...
PatientProfile copyWith({
  ...
  /// Used by the Edit Profile screen — lets every editable field change at
  /// once, unlike [copyWith] which only covers the two settings toggles.
  PatientProfile copyWithEdits({
    Gender? gender,
